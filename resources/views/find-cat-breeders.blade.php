...
@section('title','Find Cat and Kitten Breeders Near Your')


@section('desc','Find cat and kitten breeders near you using our free cattery search. Locate cat and kitten breeders from around the United States and Canada')
    ...
    <div class="column is-one-third is-offset-one-third m-t-100">
      <div class="card">
        <div class="card-content">
          <h1 class="title">Find Cat and Kitten Breeders</h1>
          <p class="is-size-6 m-b-30">Find cat and kitten breeders near you using our free cattery search. Locate cat and kitten breeders from around the United States and Canada</p>
